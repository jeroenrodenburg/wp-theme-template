    ...
    /* <![CDATA[ */
        (function () {
            ...
            if (!cssPropertyValueSupported('position', 'sticky')) {
                ...
                stickyScript.src = '" . get_template_directory_uri() . "/js/polyfills/sticky.polyfill.min.js';
            ...
            if (!cssPropertyValueSupported('object-fit', 'cover')) {
                ...
                objectFitScript.src = '" . get_template_directory_uri() . "/js/polyfills/object-fit.polyfill.min.js';
